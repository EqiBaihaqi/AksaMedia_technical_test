...
class ProductLain extends StatelessWidget {
  const ProductLain({super.key});

  @override
  Widget build(BuildContext context) {
    final producController = Get.put(ProductController());
    return Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          producController.displayBottomSheet(context);
                        },
                        child: Text(
                          'Bagikan Produk',
